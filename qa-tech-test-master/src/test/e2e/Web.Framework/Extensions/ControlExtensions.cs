...
namespace Web.Test.Extensions
{
    ...
    public static class ControlExtensions 
    {
        ...
        /// <summary>
        /// Unselected the check box element if not already unselected.
        /// </summary>
        /// <param name="element">The WebElement that is being used.</param>
        /// <param name="driver">WebDriver to work with</param>
        /// <param name="timeoutInSeconds">Timeout to find the control</param>
        ...
        /// </summary>
        /// <param name="element">The WebElement that is being used.</param>
        /// <returns>The text value from an element</returns>
        ...
        /// <summary>
        /// Waits for an element to be click-able before attempting to click it
        /// </summary>
        ...
        /// <param name="driver">The web browser driver</param>
        /// <param name="timeoutInSeconds">How long we wish to wait for in seconds</param>
        public static void WaitForJavaScriptLoading(this IWebDriver driver, int timeoutInSeconds = TimeoutInSeconds.ControlTimeout)
        {
        ...
        {
            WaitForElement(element);
            SetTimeout.ImplicitlyWait(driver, TimeSpan.FromSeconds(10));
            element.Click();
        }
        ...
        public static void GoToUrl(this string appendedUrl, IWebDriver driver)
        {
            var url = driver.Url;
